...
class CGuitars {
    static int addGuitarScriptEvent, loadGuitarScriptEvent,
        unloadingGuitarScriptEvent;
  ...
  public:
    class CGuitar {
      ...
      public:
        inline const std::string &getPath() noexcept { return path; }
    ...
    CGuitar &addGuitar(const std::string &path,
