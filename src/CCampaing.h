...
class CCampaing {
    static int campaingLoadSE, campaingInitSE, campaingMenuPreFunSE,
        campaingMenuMidFunSE, campaingMenuPosFunSE, campaingDScreenUpdateSE,
        campaingMainMenuOpenSE;
  ...
  public:
    ...
    struct Contract {
        ...
        template <class Archive> void load(Archive &archive) {
            archive(day, hour, timeToAccept, cost, expectedProfit,
                    cancellationFine, numShows, exclusivity);
        }
    ...
    class CCampaingData {
      ...
      public:
        template <class Archive> void load(Archive &archive) {
            archive(mode, campaingPlayers, bandName, money, playedTime,
                    reputationPoints, playedSongs, showsSchedule, guitars,
                    emailList, contractList, newsList, scripts);
        }
    ...
    static int registerLuaFunctions(CLuaH::luaState_t &Lstate);

    static CCampaing &campaingMGR();

    int newCampaing();
    static int continueCampaing(const std::string &path);
