  ...
  public:
    class CSave {
      ...
      public:
        ...
        template <class T> inline T getVarContent(const std::string &var) {
            T result;
        ...
        template <class T>
        inline bool addVariableAttData(const std::string &name, T &var,
                                       bool dynamic) {
            if (!loaded)
                return false;
        ...
        inline bool addVariableAttData(const std::string &name,
                                       std::string &var, bool dynamic) {
            if (!loaded)
                return false;
        ...
        template <class T>
        inline void addVariable(const std::string &name, const T &var,
                                bool dynamic) {
            variable v;
            v.name = name;
            v.size = sizeof(var);
